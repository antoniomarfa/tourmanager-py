...
jQuery( document ).ready( function( $ ) {
    var $rolesTable = jQuery("#rolesTable");
    ...
    $rolesTable.closest( '.dataTables_wrapper' ).find( 'select' ).addClass('form-control');
...
jQuery(document).on("click", ".delete-register", function(e) {
    ...
    var empresa = "{{ empresa }}";
    let baseUrl = "/" + empresa + "/manager/roles/delete/";
...
jQuery(document).on("click", ".change-status", function() {
    ...
    var empresa = "{{ empresa }}";
    var url = '/' + empresa + '/manager/roles/status';
    var data = {
        user_id: id
    }
