jQuery( document ).ready( function( $ ) {
    ...
    $('#region_id').change(function(){
        ...
        var empresa = "{{ empresa }}";
        var Url = '/' + empresa + '/manager/pasajeros/getcomune';
        var data = {
          region_id : region
          }
     ...
     $('#venta_id').change(function(){
        ...
        var venta = $(this).val();
        var empresa = "{{ empresa }}";
        var Url = '/' + empresa + '/manager/pasajeros/getventa';
        var data = {
          venta_id : venta
          }
          ...
          $.ajax({
              ...
              success: function(response){
                ...
                $('#typesale').val(response.typesale);

                if (typesale == 'VG'){
                    $('#dinamyc-row').addClass('d-none')
                    $('#rutapoderado').removeClass('require')
                    $('nombreapoderado').removeClass('require')
                }else{
                    $('#dinamyc-row').removeClass('d-block')
                    $('#rutapoderado').addClass('require')
                    $('nombreapoderado').addClass('require')
                }
